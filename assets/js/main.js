...
=================================================*/
  function _video() {
    ...
    if (isMobile) {
      ...
      $('#intro').backstretch('assets/img/bg/logo.jpg'); /* place image header on mobile */

    } else if (isIE8) {

      $.backstretch('assets/img/bg/logo.jpg'); /* place image header on ie8 */
...
=================================================*/
  function _formValidation(email_address) {
    ...
    alert(pattern.test(email_address))
